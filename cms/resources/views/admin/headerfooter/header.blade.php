      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{!! url('admin/user') !!}"><i class="fa fa-circle-o"></i>Danh sách thành viên</a></li>
            <li><a href="{!! url('admin/user/create') !!}"><i class="fa fa-circle-o"></i>Thêm thành viên</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              ...
              <ul class="treeview-menu">
                <li><a href="{!! url('admin/categoryproduct') !!}"><i class="fa fa-circle-o"></i>Danh Sách</a></li>
                <li><a href="{!! url('admin/categoryproduct/create') !!}"><i class="fa fa-circle-o"></i>Thêm Nhóm</a></li>
              </ul>
            </li>
            <li>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{!! url('admin/product/create') !!}"><i class="fa fa-circle-o"></i>Thêm Sản Phẩm</a></li>
              </ul>
            </li>
          </ul>
        </li>
        ...
        <li><a href="{!! url('admin/sitemap') !!}"><i class="fa fa-circle-o text-red"></i><span>SiteMap</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
